...
$("#meddiv").on("mousedown touchstart",Fa);$("#fknp").change(function(){ca("btn",[])});$("#mknp").change(function(){R("btn",[])});$("#yknp").click(wa);$("#yubid").keydown(function(b){b.stopPropagation()});$("#yubuse").change(fa);$("#drpuse").click(ma);$("#notation").mousedown(function(){qa()||O({keyCode:80})});$("#jump").change(ra);$("#impbox").change(Y);$("#menu * input").change(ra);$("#menu label").toggle();$("#mbar").click(function(){"none"==$("#menu label").css("display")?$("#menu label").toggle(!0):
sa()});$("#woff").change(function(){N=$(this).prop("checked")});$.event.props.push("dataTransfer");$("body").on("drop",va);$("body").on("dragover",function(b){b.stopPropagation();b.preventDefault();b.dataTransfer.dropEffect="copy"});$("body").on("dragenter dragleave",function(){$(this).toggleClass("indrag")})})})();
