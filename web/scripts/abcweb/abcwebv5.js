...
function Wijzer (xss, ymins, ymaxs, times, tixlb, lbtix, tixbts) {  // create the music cursor
    ...
    this.segno.attr ('id', 'segno'); this.segno.text ('o'); // simbolo
    this.segno.css ({fill:'red', stroke:'red', 'text-anchor':'middle'}); // css
    this.segno.attr('x', '10'); // posizione asse x
    this.segno.attr ('y', '-10'); // posizione asse y
    this.wijzer.append (this.segno);
    */
    /***** prova rettangolo *****/
...
Wijzer.prototype.setx = function (x, xleft, xright) { // horizontal position in music line
    ...
    if (opt.lncsr) {
        ...
        //console.log("x: "+x);
        this.wijzer.attr ('width', '20'); // larghezza cursore
        //
        ...
        /*
         * x = x / scala: se voglio spostamenti vicini metto una scala piccola, altrimenti grande
         * 
         * 
         */
        x = x / scale;                     // g-coors -> pixels for scroll test; scale =  0.5 va bene
        x = x.toFixed(2); // altrimenti toFixed() non funge
...
Wijzer.prototype.createRect = function (x, xleft, xright){
        console.log("disegna");
        this.segno = $(document.createElementNS('http://www.w3.org/2000/svg', 'text'));
        this.segno.attr('id', 'segno');
        this.segno.text('x'); // simbolo
        this.segno.css({fill: 'red', stroke: 'red', 'text-anchor': 'middle'}); // css
        this.segno.attr('x', '10'); // posizione asse x
        this.segno.attr('y', '-10'); // posizione asse y
        this.wijzer.append(this.segno); // fare un append momentaneo
};
/*** funzione  ***/
...
Wijzer.prototype.time2x = function (t, rondaf) {
    ...
    // inserire qui la funzione per creare il rettangolo
